...
class Customer extends User {
    ...
    public Customer(String username, String password, String customerID, String level, LocalDate registrationDate, double totalSpent, String phoneNumber, String email) {
...
class Product {
    ...
    public Product(String productID, String name, String manufacturer, LocalDate productionDate, String model, double purchasePrice, double retailPrice, int quantity) {
    ...
    public void updateProduct(String name, String manufacturer, LocalDate productionDate, String model, double purchasePrice, double retailPrice, int quantity) {
        this.name = name;
        this.manufacturer = manufacturer;
        this.productionDate = productionDate;
        this.model = model;
...
public class ShoppingSystem {
    ...
    private static void initializeData() {
        // 初始化一些客户和商品数据
        customers.put("C001", new Customer("Alice", "password123!", "C001", "金牌客户", LocalDate.parse("2023-07-19"), 1000.0, "1234567890", "alice@example.com"));
        customers.put("C002", new Customer("Bob", "password456!", "C002", "银牌客户", LocalDate.parse("2023-06-10"), 500.0, "0987654321", "bob@example.com"));

        products.put("P001", new Product("P001", "商品 1", "厂家 1", LocalDate.parse("2023-05-01"), "型号 1", 100.0, 120.0, 50));
        products.put("P002", new Product("P002", "商品 2", "厂家 2", LocalDate.parse("2023-04-15"), "型号 2", 200.0, 240.0, 30));
    }
}
